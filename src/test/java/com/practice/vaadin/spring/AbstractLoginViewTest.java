 ...
 */
public abstract class AbstractLoginViewTest extends ParallelTest {
    ...
    public AbstractLoginViewTest() {
        this("", By.tagName("body"));
    }

    protected AbstractLoginViewTest(String route, By rootSelector) {
        this.route = route;
